...
<div class="min-h-screen bg-gray-50">
    ...
    <div class="px-4 py-4 sm:px-6 lg:px-8">
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 text-center">
            ...
            <h3 class="text-lg font-semibold text-gray-700 mb-2">Manajemen User Global</h3>
            <p class="text-gray-500">Fitur manajemen user lintas tenant akan hadir di update berikutnya.</p>
        </div>
    </div>
</div>
@endsection
